...
######  屏幕保护效果图![屏幕保护效果图](./READMEPIC/QuickWin-ScreenProtection.png)
...
我们能够在菜单中的其他设置中不用操控硬件即改变屏幕亮度和屏幕对比度，且支持多屏情况。
...
###### 使用cmd指令ping www.maplefan.com ![使用cmd指令ping www.maplefan.com](./READMEPIC/QuickWin-Search4.png)
