...
void ScreenView::initColorBar()
{
    ...
    _btn_brush->setIcon(QPixmap(":/images/brush.png"));
    _btn_brush->setToolTip(tr("填充"));
	_btn_brush->setStyleSheet(s_brushStyle);
...
void ScreenView::initToolBar()
{
    ...
    _btn_yes->setFixedSize(BUTTON_WIDTH, BUTTON_HEIGHT);

    _btn_copy->setIcon(QPixmap(":/images/copy.png"));
    _btn_save->setIcon(QPixmap(":/images/save.png"));
    _btn_drawLine->setIcon(QPixmap(":/images/drawline.png"));
    _btn_drawRect->setIcon(QPixmap(":/images/drawrect.png"));
    _btn_drawEllipse->setIcon(QPixmap(":/images/drawellipse.png"));
    _btn_drawText->setIcon(QPixmap(":/images/drawtext.png"));
    _btn_yes->setIcon(QPixmap(":/images/yes.png"));
	
    _btn_copy->setToolTip(tr("复制到剪贴板"));
    _btn_save->setToolTip(tr("保存到文件"));
    _btn_drawLine->setToolTip(tr("绘制线段"));
    _btn_drawRect->setToolTip(tr("绘制矩形"));
    _btn_drawEllipse->setToolTip(tr("绘制椭圆"));
    _btn_drawText->setToolTip(tr("添加文本"));
    _btn_yes->setToolTip(tr("确定"));
	...
	_btn_drawEllipse->setStyleSheet(s_normalStyle);
	_btn_drawText->setStyleSheet(s_normalStyle);
    _btn_yes->setStyleSheet(s_normalStyle);
    ...
    mainToolBarLayout->addWidget(_btn_yes);
    ...
    connect(_btn_yes, SIGNAL(clicked()), this, SLOT(showImage()));
