    ...
    ui(new Ui::DragAbleWidget)
{
    ...
    connect(ui->btn_Close , SIGNAL(clicked(bool)) , this , SLOT(closeBtn()));
    mTimer->start();
...
void DragAbleWidget::doShowFullScreen()
{
    ...
    ui->btnMenu_Max->setIcon(QIcon(":/images/shownormalbtn.png"));
...
void DragAbleWidget::doShowNormal()
{
    ...
    ui->btnMenu_Max->setIcon(QIcon(":/images/showmaxsizebtn.png"));
...
void DragAbleWidget::keyPressEvent(QKeyEvent *ev)
{
    if(this->isFullScreen()){
